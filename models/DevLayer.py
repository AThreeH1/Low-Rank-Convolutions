import math
from models.Devnet import so_uniform_init_
from models.expm import expm, rescaled_matrix_exp
import torch
...
class projection(nn.Module):
    def __init__(self, input_size, hidden_size, channels=1, param=so, triv=expm, **kwargs):
...
class development_layer(nn.Module):
    ...
    def __init__(self, input_size: int, hidden_size: int, channels: int = 1, param=so,
